"""CineInfini – Video Quality Audit Pipeline (v0.4.7)."""
from __future__ import annotations
__version__ = "0.4.7"; __author__ = "Salah-Eddine BENBRAHIM"; __license__ = "MIT"
...
from .core.phase4_aggregator import aggregate_shot_verdict, build_phase4_report, GateThresholds, ShotVerdict
...
def get_config_dict() -> dict: return CONFIG.copy()
def set_config_key(key: str, value) -> None:
    if key not in CONFIG: raise KeyError(f"Unknown CONFIG key: '{key}'")
    CONFIG[key] = value

__all__ = [
    "__version__",
    "audit_video", "adaptive_multi_stage_audit", "generate_synthetic_video",
    "CONFIG", "set_global_paths", "run_audit",
    ...
    "default_config", "test_config", "load_config", "save_config", "Config",
    "calibrate_from_csv", "grid_search_thresholds",
    "logistic_regression_weights", "bayesian_optimize_thresholds", "CalibrationResult",
    ...
    "VideoContext", "VideoInfoLite", "ModelPool",
    "register_module", "get_registry", "get_active_modules",
    "all_modules", "reset_registry", "ModuleEntry",
    "register_renderer", "get_ui_registry", "get_active_renderers",
    "all_renderers", "reset_ui_registry", "RendererEntry",
